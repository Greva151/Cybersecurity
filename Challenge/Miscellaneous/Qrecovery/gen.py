...
for _ in permutazioni:
    ...
    a_order = [str(_[0]), str(_[1]), str(_[2]), str(_[3])]  # UPDATE ME
    b_order = [str(_[3]), str(_[2]), str(_[1]), str(_[0])]  # UPDATE ME
    ...
    reconstructed_image.save(f"obscured{_[0]}{_[1]}{_[2]}{_[3]}.png")
